...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Manage your customer list</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $client->company ?? 'N/A' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $client->created_at->format('M d, Y') }}</td>
        ...
        <div class="text-center py-12">
            ...
            <p class="text-gray-600 mb-6">Start by adding your first client.</p>
            <a href="{{ route('clients.create') }}"
